      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'RAG 评估', link: '/guide/evaluation' },
            { text: '定时同步与批量导入', link: '/guide/scheduler' },
            { text: '测试指南', link: '/guide/testing' },
            { text: 'CLI 命令参考', link: '/guide/cli-reference' },
      ...
      '/architecture/': [
        {
          ...
          items: [
            ...
            { text: 'Graph RAG 增强检索', link: '/architecture/graph-rag' },
            { text: 'WebSocket 实时推送', link: '/architecture/websocket' },
            { text: 'Agentic RAG 多步推理', link: '/architecture/agentic-rag' },
            { text: '评估流水线', link: '/architecture/evaluation' },
            { text: '意图路由', link: '/architecture/intent-routing' },
            { text: '会话管理', link: '/architecture/session' },
            { text: '可观测性架构', link: '/architecture/telemetry' },
          ],
        },
      ],
      '/concepts/': [
      ...
      '/deployment/': [
        {
          ...
          items: [
            ...
            { text: '可观测性与链路追踪', link: '/deployment/observability' },
            { text: '分布式部署', link: '/deployment/distributed' },
            { text: 'CI/CD 流水线', link: '/deployment/ci-cd' },
          ],
        },
      ],
    },
